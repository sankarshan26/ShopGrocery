...
const ProductPage = () => {
  ...
  const getproductdatabyid = async () => {
    ...
    const product = products.find(product =>{return product.ProductId === parseInt(prodid)});
    //used parseInt to convert string to integer as ID returned by useParams() is string    
