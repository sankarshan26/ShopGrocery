      ...
      <div className="cart">
        <div className="progress">
          {active === 1 ? (
            <div
              className="c11"
              onClick={() => {
                checklogin() && cartdata.length > 0 && setactive(1);
              }}
            >
              <svg
          ...
          {active === 2 ? (
            <div
              className="c11"
              onClick={() => {
                checklogin() && cartdata.length > 0 && setactive(2);
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {active === 3 ? (
            <div
              className="c11"
              onClick={() => {
                checklogin() && cartdata.length > 0 && setactive(3);
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {active === 4 ? (
            <div
              className="c11"
              onClick={() => {
                checklogin() && cartdata.length > 0 && setactive(4);
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                    ...
                    return (
                      <tr key={index} className="cartitemrow">
                        <td data-label="Product">
                          <Link
                            className="cartproduct stylenone"
                            to={`/product/${item.productdata.ProductId}`}
                          >
                            <img
        ...
        {active === 3 && (
          <div className="paymentcont">
            ...
            <div className="c2"><span>Net Total</span>&nbsp;&nbsp;<span>${(subtotal+tax+shipping).toFixed(2)}</span></div>
          </div>
        )}
        {active === 4 && (
